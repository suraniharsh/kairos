...
pub fn run() -> io::Result<()> {
    ...
    match kind {
        InstallKind::Homebrew => {
            ...
            println!();
            println!("    brew update && brew upgrade suraniharsh/kairos");
        }
        InstallKind::Cargo => {
            println!("Looks like a `cargo install` build. Update with:");
            println!();
            println!("    cargo install --git https://github.com/suraniharsh/kairos --force");
        }
        InstallKind::Binary => {
            println!("Looks like a downloaded binary. Grab the latest from:");
            println!();
            println!("    https://github.com/suraniharsh/kairos/releases/latest");
            println!();
        ...
        InstallKind::Unknown => {
            ...
            println!();
            println!("    brew upgrade suraniharsh/kairos");
            println!("    cargo install --git https://github.com/suraniharsh/kairos --force");
            println!("    https://github.com/suraniharsh/kairos/releases/latest");
        }
    }
